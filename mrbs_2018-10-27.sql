...
#
# Host: 140.115.188.87 (MySQL 5.5.5-10.3.7-MariaDB)
# Database: mrbs
# Generation Time: 2018-10-27 14:20:56 +0000
# ************************************************************
...
CREATE TABLE `mrbs_deptmanager` (
  ...
  `uname` varchar(30) CHARACTER SET latin1 DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `area_id` (`aid`),
  KEY `user_id` (`uid`),
...
VALUES
	...
	(45,1538879400,1538883000,0,NULL,1008,'2018-10-07 12:40:46','user','','帥哥我','I','',0,NULL,NULL,NULL,NULL,'MRBS-5bb98dfe45507-969f724d@book.ncuisq.tk',1,NULL),
	(47,1538875800,1538879400,0,NULL,1008,'2018-10-07 16:48:32','User','','Meng-Sheng Lai','I','',0,NULL,NULL,NULL,NULL,'MRBS-5bb9c712e2d2c-8b871bf2@localhost',1,NULL),
	(51,1538962200,1538965800,0,NULL,2008,'2018-10-08 11:08:04','user','','USER1','I','',0,NULL,NULL,NULL,NULL,'MRBS-5bba36ee6297d-6ff04caa@localhost',1,NULL);
...
VALUES
	(3,3,'mrbs','$2y$10$eRpDptunyKTgdOwraMP3Ge/5yYfcdZK/CKlacn1N3lhYK8CpJQevm','mrbs@reservation.ncu.edu.tw','2018-10-27 21:50:49',NULL,1,NULL),
	(4,1,'user','$2y$10$/Yg5GUsoR.LQ9Cru/P9XhePrcTOOZfxEeOAQaAr/gOC.mUqfcNyNC','106423040@cc.ncu.edu.tw','2018-10-27 21:50:53',NULL,1,NULL),
	(5,2,'dept','$2y$10$SbUDAzHZhrP6vafaqdq7NurkJRwAIupSifekCMTVV1VhZxevvMw86','spyro12393@g.ncu.edu.tw','2018-10-27 21:50:54',NULL,1,NULL),
	(6,0,'none','$2y$10$u7sEyZfyJnbDvaWd/HRs8Or9sEdkF0JCKlx87MwS4hWSjB5dSaI2q','none@g.ncu.edu.tw','2018-10-27 21:50:55',NULL,1,NULL),
	(10,2,'dept2','$2y$10$yA2wBMT9jUenjvkUoEmC1.Dyyjg3gbodDm8J02H7JvKIc3VpI0KlW','spyro12393@g.ncu.edu.tw','2018-10-27 21:50:56',NULL,1,NULL),
	(11,1,'users','$2y$10$udWfGO/rpUc67JjBGLJ6a.y8qdm6o0HkPrfjL1GLHgLuxsv0lJG.K','a294948s5@yahoo.com','2018-10-27 21:50:58',NULL,1,NULL);
...
CREATE TABLE `mrbs_users_valid` (
  ...
  `timesstamp` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
